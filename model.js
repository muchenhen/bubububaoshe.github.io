...
COMMON_CHAR_LIST = [
  [
    // ['ly1','陵越',2,'冬','剑意御风凌山月，往事伴烛映霜雪。'],
    // ['qy1','悭臾',2,'夏','东海祖州识命魂，不周山下多古意。'],
    // ['fqx1','风晴雪',2,'春','青丝银栉别样梳，天付婆娑入画图。'],
    // ['tyc1','天墉城',2,'夏','昆仑山巅修至道，剑御四野灵空明。'],
    // ['hllp1','黑龙鳞片',2,'夏','浮云一别未虚掷，光阴荏冉故人来。'],
    // ['gjfj1','古剑焚寂',2,'夏','琴心剑魄今何在，留见星虹贯九天。'],
    // ['zrl1','紫榕林',2,'秋','湖天春色归路迷，幼狐梦醒眼迷离。'],
    // ['xf1','巽芳',2,'春','芳华如梦佳期逝，蓦然回首柔情旧。'],
    // ['gjhy1','古剑红玉',2,'夏','枫落龙渊宿此间，青锋不再伴恨眠。'],
    // ['qysnp1','青玉司南佩',2,'春','曲终人散心不悔，一魂一魄永相随。'],
    // ['xl1','襄铃',2,'夏','额前未肯点胭脂，懒把相思细细知。'],
    // ['blts1','百里屠苏',2,'冬','古剑铁衣映清辉，百劫阎浮一念微。'],
    // ['fls1','方兰生',2,'春','嫏嬛久觅紫云乡，半枕清风鹤梦长。'],
    // ['yqs1','尹千觞',2,'秋','江湖肝胆风波促，万里云山醉梦真。'],
    // ['hy1','红玉',2,'秋','九重环佩艳琳琅，一段红绡旖旎长。'],
    // ['oysg1','欧阳少恭',2,'秋','风前独坐弄琴筝，明灭蓬山九万程。'],
    // ['qyt1','青玉坛',2,'秋','试心桥上分阴阳，魂兮魄兮难辨章。'],
    // ['ys1','榣山',2,'秋','沧海桑田新几度，月明还照旧容颜。'],
    // ['pl1','蓬莱',2,'夏','青阶似洗驻岁华，蓬山曲径情无暇。'],
    // ['qc1','琴川',2,'春','杏花微雨沾衣湿，陌路少年檐下识。'],
    // ['al1','安陆',2,'秋','醉白楼旁杏林黄，岁首辞君别无恙。'],
    // ['thg1','桃花谷',2,'春','花开花落蜂蝶舞，日出日落泉叮咚。'],
    // ['yd1','幽都',2,'冬','娲皇故里聚先贤，风雨如晦葬龙渊。'],
    // ['jt1','焦炭',2,'夏','天地为炉生妙物，阴阳为炭造化功。'],
    // ['fl1','凤来',2,'春','神识邈邈拂丝弦，人间离散月又圆。'],
    // ['bsd1','百胜刀',2,'冬','白刃出鞘饮煞气，世事斗转换乾坤。'],
    // ['ax1','阿翔',2,'冬','一团冰雪含奇质，万里云霄豁俊眸。'],
    // ['hyh1','红叶湖',2,'夏','野睛露染狐呜咿，红塘落叶榕嘘摇。']],
  [
    ['sy2','沈夜',2,'冬','时烬未烬陷永夜，归期无期月寒沉。'],
    ['sx2','沈曦',2,'春','梦呓短歌消长夜，吉光片羽碎琉璃。'],
    ['lyc2','流月城',2,'冬','月冷千山孤城悬，神木凋零远人间。'],
    ['xyz2','夏夷则',2,'冬','八极乘龙巡碧落，一襟风雪载昆仑。'],
    ['ths2','太华山',2,'冬','巍巍云巅鹤长唳，亭亭尘外山色霁。'],
    ['hy2','华月',2,'冬','元月夜下箜篌引，不负相思不负君。'],
    ['zm2','昭明',2,'春','星屑玉魄结剑还，光耀四野止寒夜。'],
    ['ar2','阿阮',2,'春','楚梦沉醉朝复暮，清歌远上巫山低。'],
    ['yq2','禺期',2,'夏','一世仙身为剑痴，晗光蕴灵万事知。'],
    ['ywy2','乐无异',2,'夏','杨柳风前歌玉树，黄金堂下卧麒麟。'],
    ['wc2','忘川',2,'冬','寂灭幻断前缘尽，旋刺斩决君子心。'],
    ['lc2','露草',2,'春','天地灵韵凝霜骨，剑心支离相思苦。'],
    ['qhzr2','清和真人',2,'秋','明哲通达出太华，山河秀丽诗酒花。'],
    ['wmzj2','无名之剑',2,'秋','上古威仪难复现，敛光为华唤明心。'],
    ['ca2','长安',2,'春','众人揽胜逐朝霞，游子笑折一枝花。'],
    ['gjhg2','古剑晗光',2,'冬','传世利刃寒光荧，千秋凡铁宿魂灵。'],
    ['jql2','金麒麟',2,'秋','江上熏风鸳鸯游，两小无猜赠麒麟。'],
    ['ttzq2','通天之器',2,'秋','天道浩瀚难穷尽，若涉渊水正道心。'],
    ['ws2','巫山',2,'夏','风飖轻举降暮雨，碧峭绵延匿神女。'],
    ['wry2','闻人羽',2,'秋','朱颜流落东风里，月满千山倚筑歌。'],
    ['bcg2','百草谷',2,'夏','横戈盘马草如茵，介胄执袍郁成阴。'],
    ['tzbz2','兔子抱枕',2,'秋','长长折耳护稚童，圆圆黑眸沐春风。'],
    ['xy2','谢衣',2,'夏','花落庭前浮图现，人间尽是晚晴天。'],
    ['jsh2','静水湖',2,'春','水天一色洗尘嚣，帘栊垂落与神交。'],
    ['snm2','神女墓',2,'冬','神农座下披华藻，行云带雨香陨早。'],
    ['hykh2','华月箜篌',2,'冬','凝音织梦倚阑珊，清商抚羽月沉沦。'],
    ['jd2','捐毒',2,'秋','玉门关外祭坛成，浑邪葬处沙倾城。'],
    ["cj2", "馋鸡", 2, "春", "北溟鲲游翻海震，袖藏禅机翥天飞。"]],
  [
    ["bl3", "北洛", 2, "秋", "璞玉浑金珠光淡，晦迹韬光识乾坤。"],
    ["ywy3", "云无月", 2, "冬", "既出丹渊交光夜，凝雾点漆逸流萤。"],
    ["cy3", "岑缨", 2, "夏", "豆火薪传笑嫣然，书帷漫卷睛灵秀。"],
    ["jxy3", "姬轩辕", 2, "春", "天何所沓梦归崖，日月入怀星分阵。"],
    ["jy3", "缙云", 2, "秋", "岁付征鸿辉斗柄，剑破寰宇卫荒服。"],
    ["wz3", "巫炤", 2, "冬", "空阶拥璇献沉壁，枉消虚过碎玉衡。"],
    ["sw3", "司危", 2, "夏", "韶颜稚尺芳菲逝，朱轮惘惘笑移蚀。"],
    ["xgns3", "玄戈&霓商", 2, "冬", "惊风奔雷骋四野，重帘暮深落星沉。"],
    ["lz3", "嫘祖", 2, "夏", "掷镜秉钺自光辉，孤城折冲定风波。"],
    ["lx3", "刘兄", 2, "春", "青丘尘中犹独醒，夕寐霄兴叙多情。"],
    ["tlc3", "天鹿城", 2, "秋", "霄虹纹彩九千仞，莫见阙角倚碧海。"],
    ["xl3", "西陵", 2, "秋", "鸢飞丘墟千嶂叠，狼烟恒亘背花烬。"],
    ["yl3", "鄢陵", 2, "春", "折花掷果麴盈车，华红叠翠醉春晖。"],
    ["yx3", "有熊", 2, "秋", "固城筑基共拾火，绯云漫卷覆短墙。"],
    ["bmz3", "白梦泽", 2, "春", "旧时泽畔刺荆心，云散雾始咏初年。"],
    ["wzg3", "巫之国", 2, "冬", "寂寂无声伴永生，堭堭空音苍梧谣。"],
    ["dh3", "鼎湖", 2, "冬", "神与行处凝涧壑，帐殿倚云破冰枝。"],
    ["cs3", "赤水", 2, "夏", "未闻龙啸绝凌云，残灯耿夜拾遗珠。"],
    ["yp3", "阳平", 2, "夏", "谷旦净扫立修竹，斜阳照拂连巴蜀。"],
    ["wmzd3", "无名之地", 2, "冬", "生生死死漠无声，影影绰绰空载魂。"],
    ["ts3", "太岁", 2, "冬", "照之以日月，经之以星辰，纪之以四时，要之以太岁。"],
    ["yts3", "原天柿", 2, "春", "结庐莲境持家计，饱卧汤泉乡其音。"],
    ["hb3", "画板", 2, "夏", "聿画三界行九州，千秋入墨成陈迹。"],
    ["bhl3", "半魂莲", 2, "夏", "浮生聚散梦连陇，天星摇落尽成空。"],
    ["ys3", "玉梳", 2, "春", "旧梦如昨梳叠云，故国凋零意难平。"],
    ["qqczj3", "青丘尘中记", 2, "春", "闲情偶寄旦付梓，一语成谶结狐缘。"],
    ["mhz3", "梦魂枝", 2, "秋", "切切以旧梦为恨，点点以残魂为引。"],
    ["tl3", "天鹿", 2, "秋", "籍籍征战遏群魔，迢迢高城远人间。"]]
];
COMBO_LIST  = [
...
class Player {
  ...
  getDesc() {
    var msg = "玩家" + this.id;
    msg += "手牌：" + this.hand.getDesc();
    msg += "桌面：" + this.table.getDesc();
    msg += "特殊牌：" + this.specials.getDesc();
    return msg;
  }
}
class Model {
